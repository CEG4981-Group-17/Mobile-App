...
// reference: https://github.com/NordicSemiconductor/Android-nRF-Blinky/blob/master/app/src/main/java/no/nordicsemi/android/blinky/profile/BlinkyManager.java
...
public class DevicesLiveData extends LiveData<List<DiscoveredBluetoothDevice>> {
    private static final ParcelUuid FILTER_UUID = new ParcelUuid(ICMManager.SERVICE_UUID);
    ...
    private boolean matchesNearbyFilter(final int rssi) {
        if (!filterNearbyOnly) return true;
